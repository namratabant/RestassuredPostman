...
public class XMLTest {
		...
		public void test1() {
			...
			RestAssured.given()
						.baseUri("https://chercher.tech/sample/api/books.xml") //xml url 
						.when()
						.get()
						.then()
						.log()
		...
		public void test2() {
			...
			Response response = RestAssured.given()
											...
											.get();
			//to get title
			NodeChildrenImpl books = response.then().extract().path("bookstore.book.title");//insted of .title , .authour also we can give
